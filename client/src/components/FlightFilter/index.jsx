    ...
    <div className="rounded-lg bg-white p-6 w-full">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-6">
        ...
        <div className="text-sm mt-4 md:mt-0">
          <div className="rounded-xl overflow-hidden flex cursor-pointer w-full">
            <div className="w-1/2 bg-appColor text-white flex justify-center items-center rounded-l-xl">
              Round Trip
            </div>
            <div className="w-1/2 flex justify-center items-center bg-purple-400 text-appColor rounded-r-xl">
              One way
            </div>
          </div>
        </div>
      ...
      <div className="mt-5 flex justify-center md:justify-start">
        <button
          ...
          className="bg-appColor text-white text-center p-2 rounded w-full md:w-auto"
        >
          Show Flights
        </button>
      </div>
